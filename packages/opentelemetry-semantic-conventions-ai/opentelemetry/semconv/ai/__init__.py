...
class SpanAttributes:
    ...
    INSIGHTFINDER_ENTITY_KWARGS = "insightfinder.entity.kwargs"
    INSIGHTFINDER_ENTITY_RESULT = "insightfinder.entity.res"
    INSIGHTFINDER_ENTITY_PROMPT_TOKEN = "insightfinder.entity.prompt_token"
    INSIGHTFINDER_ENTITY_EVAL_TOKEN = "insightfinder.entity.eval_token"
    INSIGHTFINDER_ENTITY_COMPLETION_TOKEN = "insightfinder.entity.completion_token"
    INSIGHTFINDER_ENTITY_TOTAL_TOKEN = "insightfinder.entity.total_token"
    INSIGHTFINDER_ENTITY_ERROR_MESSAGES = "insightfinder.entity.error_messages"
    INSIGHTFINDER_ENTITY_TOTAL_DURATION = "insightfinder.entity.total_duration"
    INSIGHTFINDER_ENTITY_LOAD_DURATION = "insightfinder.entity.load_duration"
